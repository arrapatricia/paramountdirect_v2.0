  ...
  return (
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto font-sans text-slate-900 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-5 shadow-sm">
          <h3 className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2">COCs Issued (YTD)</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm flex flex-col">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-sm font-extrabold text-slate-800 uppercase">Policy Type</h2>
              <p className="text-xs text-slate-500 font-medium">Private Car vs. Motorcycle vs. Commercial</p>
            </div>
            ...
            <div className="relative w-48 h-48 rounded-full" style={{ background: policyGradient }}>
              <div className="absolute inset-[16px] rounded-full bg-white flex items-center justify-center">
                <div className="text-center">
                  <span className="block text-2xl font-black text-slate-900">{policyTotal.toLocaleString()}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm">
          <h2 className="text-sm font-extrabold text-slate-800 uppercase mb-1">Top Vehicle Types</h2>
          <p className="text-xs text-slate-500 font-medium mb-5">Applications by LTO MV Type, 2026 YTD</p>
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl border border-slate-200 p-6 shadow-sm">
          <div className="flex items-start space-x-2 mb-4">
            ...
            <div>
              <h2 className="text-sm font-extrabold text-slate-800 uppercase">Plate Ending Schedule</h2>
              <p className="text-xs text-slate-500 font-medium">Coverage effectivity by ending plate digit (LTO staggered registration)</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
            {PLATE_ENDING_SCHEDULE.map((row) => (
              <div key={row.ending} className="flex items-center justify-between px-3 py-2 rounded-lg bg-[#ebf3fc]">
                <span className="font-black text-[#002f6c]">Ending {row.ending}</span>
                <span className="font-bold text-slate-600">{row.month}</span>
              </div>
            ))}
          </div>
        </div>
