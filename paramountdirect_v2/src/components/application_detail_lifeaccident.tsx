      ...
      <div className="space-y-6 pb-20">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl text-xs">
            <div className="flex items-center"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Campaign Source</label><select {...getSelectProps('general')}><option>Telemarketing</option></select></div><div className="hidden md:block"></div>
            <div className="flex items-center"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Plan</label><select {...getSelectProps('general')}><option>1 Unit</option><option>2 Units</option></select></div><div className="hidden md:block"></div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="space-y-4 text-xs max-w-4xl">
            <div className="flex items-center"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Title</label><select {...getSelectProps('personal')} className={`${getSelectProps('personal').className} max-w-[120px]`}><option>Mr</option><option>Ms</option></select></div>
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1 flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2"><span className="text-slate-500 font-semibold dark:text-slate-400">Age:</span><span className="px-3 py-1.5 bg-red-50 border border-red-100 text-[#d0112b] font-black rounded-lg dark:bg-red-950/30 dark:border-red-900/40">{calculateAge(birthdate)} yrs</span></div>
              </div>
            </div>
            <div className="flex items-start"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300 mt-2">Place Of Birth</label><div className="flex-1"><input type="text" {...getInputProps('personal', '')} /></div></div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="space-y-4 text-xs max-w-4xl">
            ...
            <div className="flex items-center pt-2"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Mobile Number</label><div className="w-48"><input type="text" {...getInputProps('contact', '09367284148')} /></div></div>
            <div className="flex items-center"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Telephone Number</label><div className="w-48"><input type="text" {...getInputProps('contact', '')} /></div></div>
            <div className="flex items-center"><label className="w-40 font-semibold text-slate-700 dark:text-slate-300">Email Address</label><div className="w-72"><input type="text" {...getInputProps('contact', 'rea.toribio@paramount.com.ph')} /></div></div>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="space-y-4 text-xs max-w-4xl">
            <p className="text-slate-600 font-medium mb-2 dark:text-slate-300">If premium is unpaid on expiry of grace period, apply cash value, if any, to effect:</p>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="space-y-4 text-xs max-w-4xl">
            ...
            {hasOtherLifeInsurance && (
              <div className="flex items-start">
                <label className="w-40 font-semibold text-slate-700 dark:text-slate-300 mt-2">If yes, please provide details</label>
